  ...
  public: {
    Tables: {
      ...
      establishments: {
        ...
        Insert: { id?: string; name: string; address?: string | null; org_id: string; created_at?: string }
        Update: { id?: string; name?: string; address?: string | null; org_id?: string; created_at?: string }
        Relationships: [
