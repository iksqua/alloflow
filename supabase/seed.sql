...
-- 4. Produits
-- -----------------------------------------------------------------------------
INSERT INTO public.products (id, establishment_id, name, emoji, price, tva_rate, category, category_id, is_active, sort_order) VALUES
  -- Cafés
  ('00000000-0000-0000-0003-000000000001', '00000000-0000-0000-0000-000000000010', 'Espresso',           '☕', 1.82, 10, 'boisson', '00000000-0000-0000-0001-000000000001', true, 1),
  ('00000000-0000-0000-0003-000000000002', '00000000-0000-0000-0000-000000000010', 'Americano',          '☕', 2.00, 10, 'boisson', '00000000-0000-0000-0001-000000000001', true, 2),
  ('00000000-0000-0000-0003-000000000003', '00000000-0000-0000-0000-000000000010', 'Cappuccino',         '☕', 2.55, 10, 'boisson', '00000000-0000-0000-0001-000000000001', true, 3),
  ('00000000-0000-0000-0003-000000000004', '00000000-0000-0000-0000-000000000010', 'Latte Vanille',      '☕', 3.18, 10, 'boisson', '00000000-0000-0000-0001-000000000001', true, 4),
  ('00000000-0000-0000-0003-000000000005', '00000000-0000-0000-0000-000000000010', 'Matcha Latte',       '🍵', 3.64, 10, 'boisson', '00000000-0000-0000-0001-000000000001', true, 5),
  ('00000000-0000-0000-0003-000000000006', '00000000-0000-0000-0000-000000000010', 'Chocolat Chaud',     '🍫', 2.73, 10, 'boisson', '00000000-0000-0000-0001-000000000001', true, 6),
  -- Cookies
  ('00000000-0000-0000-0003-000000000007', '00000000-0000-0000-0000-000000000010', 'Cookie Choco',       '🍪', 1.64, 5.5, 'dessert', '00000000-0000-0000-0001-000000000002', true, 1),
  ('00000000-0000-0000-0003-000000000008', '00000000-0000-0000-0000-000000000010', 'Cookie Pistache',    '🍪', 1.82, 5.5, 'dessert', '00000000-0000-0000-0001-000000000002', true, 2),
  ('00000000-0000-0000-0003-000000000009', '00000000-0000-0000-0000-000000000010', 'Cookie Double Choco','🍪', 1.73, 5.5, 'dessert', '00000000-0000-0000-0001-000000000002', true, 3),
  ('00000000-0000-0000-0003-000000000010', '00000000-0000-0000-0000-000000000010', 'Cookie Caramel Salé','🍪', 1.82, 5.5, 'dessert', '00000000-0000-0000-0001-000000000002', true, 4),
  -- Boissons fraîches
  ('00000000-0000-0000-0003-000000000011', '00000000-0000-0000-0000-000000000010', 'Limonade Maison',        '🥤', 2.55, 10, 'boisson', '00000000-0000-0000-0001-000000000003', true, 1),
  ('00000000-0000-0000-0003-000000000012', '00000000-0000-0000-0000-000000000010', 'Ice Tea Pêche',          '🥤', 2.36, 10, 'boisson', '00000000-0000-0000-0001-000000000003', true, 2),
  ('00000000-0000-0000-0003-000000000013', '00000000-0000-0000-0000-000000000010', 'Smoothie Fruits Rouges', '🧃', 3.36, 10, 'boisson', '00000000-0000-0000-0001-000000000003', true, 3),
  ('00000000-0000-0000-0003-000000000014', '00000000-0000-0000-0000-000000000010', 'Eau Sparkling',          '💧', 1.27, 10, 'boisson', '00000000-0000-0000-0001-000000000003', true, 4),
  -- Viennoiseries
  ('00000000-0000-0000-0003-000000000015', '00000000-0000-0000-0000-000000000010', 'Croissant',         '🥐', 1.14, 5.5, 'dessert', '00000000-0000-0000-0001-000000000004', true, 1),
  ('00000000-0000-0000-0003-000000000016', '00000000-0000-0000-0000-000000000010', 'Pain au Chocolat',  '🥐', 1.27, 5.5, 'dessert', '00000000-0000-0000-0001-000000000004', true, 2),
  ('00000000-0000-0000-0003-000000000017', '00000000-0000-0000-0000-000000000010', 'Muffin Myrtille',   '🧁', 1.73, 5.5, 'dessert', '00000000-0000-0000-0001-000000000004', true, 3),
  -- Merch
  ('00000000-0000-0000-0003-000000000018', '00000000-0000-0000-0000-000000000010', 'Tote Bag Alloflow', '🎁', 12.50, 20, 'autre', '00000000-0000-0000-0001-000000000005', true, 1),
  ('00000000-0000-0000-0003-000000000019', '00000000-0000-0000-0000-000000000010', 'Mug Alloflow',      '☕', 10.00, 20, 'autre', '00000000-0000-0000-0001-000000000005', true, 2),
  ('00000000-0000-0000-0003-000000000020', '00000000-0000-0000-0000-000000000010', 'T-Shirt Logo',      '👕', 20.00, 20, 'autre', '00000000-0000-0000-0001-000000000005', true, 3)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.stock_items
  (id, establishment_id, name, category, quantity, unit, min_quantity, supplier, supplier_ref, unit_price, order_quantity, active)
VALUES
...
UPDATE public.recipes SET recipe_id = NULL WHERE true; -- reset au cas où
